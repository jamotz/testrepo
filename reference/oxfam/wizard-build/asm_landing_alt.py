#!/usr/bin/env python3
"""Assemble the Oxfam wizard landing page: embed fonts + logo SVG + photos.
...
Output: <scratchpad>/oxfam-wizard-landing-alt.html (or ./oxfam-wizard-landing.html)."""
...
src = (build / "landing-alt.src.html").read_text()
...
out = out_dir / "oxfam-wizard-landing-alt.html"
out.write_text(src)
