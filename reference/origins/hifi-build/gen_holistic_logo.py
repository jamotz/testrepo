...
GH = int(TARGET * 1.06); GW = int(GH * 1.0)
t = int(GW * 0.37); r = int(t * 0.12)
...
leafL, leafW = int(GH * 0.5), int(t * 0.5)
cut_leaf(t / 2, GH / 2, leafL, leafW, math.pi / 2 - 0.22)
cut_leaf(GW - t / 2, GH / 2, leafL, leafW, math.pi / 2 + 0.22)
